    ...
    return(  
      <div className={background.background}>         {/*背景*/}
        <div className={toppart.topcover}>            {/*顶端遮罩*/} 
          <div className={toppart.poe_button}>        {/*左上角poe模块*/}
            <span>Poe</span>
            <img src={poe} alt="poe"/>
          </div>
          <div className={toppart.chatgpt_button}>    {/*正上方chatgpt模块*/}
        ...
        <div className={leftpart.leftcover}>          {/*左侧遮罩*/}
          <div className={leftpart.explore_button}>   {/*左侧explore模块*/}
            <img src={explore} alt="explore"/>    
            <span>Explore</span>
            <img src={explore_arrow} alt="explore_arrow"/>  
          </div>

          <div className={leftpart.create_bot_button}> {/*左侧create_bot模块*/}
          ...
          <div className={leftpart.download_ios_app}>  {/*左侧列表download_ios_app模块*/}
            <button className={leftpart.download_ios_app_inner}>
